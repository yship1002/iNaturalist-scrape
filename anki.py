...
def scrape_taxon_data(taxon_id):
    ...
    print(f'https://api.inaturalist.org/v1/taxa/{taxon_id}')
    try:
...
def main():
    ...
    for line in lines[600:]:
        # Process each line (here we are just printing it)
        taxon_url=line
    ...
    package.write_to_file('iNaturalistDeck2.apkg')
